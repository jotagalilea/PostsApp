...
data class PostDBObject(
	 ...
	 */
	fun asDomainModel(): com.jotagalilea.posts.model.model.Post {
		return com.jotagalilea.posts.model.model.Post(
			id = this.id,
			userId = this.userId,
			title = this.title,
			body = this.body
 ...
 */
fun List<PostDBObject>.asDomainModelMap(): Map<Int, com.jotagalilea.posts.model.model.Post>{
	return map {
