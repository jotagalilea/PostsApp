...
import com.company.mobile.android.appname.app.common.errorhandling.ErrorMessageForDialog
import com.jotagalilea.posts.R
import com.jotagalilea.posts.common.util.ResourceUtils
...
class ErrorDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val colorString = ResourceUtils.getColorString(requireActivity(), R.color.black)
